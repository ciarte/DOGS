...
export function DogsCreate() {
  ...
  const dogDetailBackUp = useSelector((state) => state.dogDetailBackUp);
  console.log(dogDetailBackUp)
  ...
  return (
    <div className={s.backCreate}>
      <nav className={s.wrapper}>
        ...
        {dogDetailBackUp.id?
        <NavLink style={{ height: "56px", marginTop: "20px" }} to={`/details/${dogDetailBackUp.id}`}>
         LAST DOG VISIT
        </NavLink>: <></>}
      </nav>
          ...
          <form onSubmit={(e) => handleSubmit(e)}>
            ...
            <div>
              <label className={st.title}>
                ...
                <p
                  style={{
                    visibility: isError.minHeight ? "visible" : "hidden",
                  }}
                >
                  {isError.minHeight}
                </p>
            ...
            <div>
              ...
              <label className={st.title}>
                ...
                <p
                  style={{
                    visibility: isError.minWeight ? "visible" : "hidden",
                  }}
                >
                  {isError.minWeight}
                </p>
